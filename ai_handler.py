    ...
    def parse_reminder(self, text):
        ...
        {{
            ...
            "recurring_params": {{
                ...
                "day_of_week": "Monday"..."Sunday" (only if weekly),
        ...
        - "Every Monday at 9am tell me to start the report": {{"text": "Start the report", "trigger_type": "recurring", "trigger_time": "09:00", "recurring_params": {{"type": "weekly", "interval": 1, "day_of_week": "Monday"}}}}
